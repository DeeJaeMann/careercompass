...
class Keyword(models.Model):
    category = models.CharField(blank=False, null=False, max_length=10, validators=[validate_category])
    name = models.CharField(blank=False, null=False, max_length=30, validators=[validate_name])
